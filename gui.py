...
class LabelTool():
    def __init__(self, master):
        ...
        self.videoPanel = Canvas(self.frame,bd=2,relief=SOLID)
    ...
    def loadDir(self, dbg=False):
        if not dbg:
            ...
            self.videoPanel.config(width=self.vid.width,height = self.vid.height)
            self.delay = 30
            self.update()
    ...
    def loadImage(self):
        ...
        self.number_plate_record[imagepath]=nbr_plate
        self.text_label.config(text=nbr_plate)
